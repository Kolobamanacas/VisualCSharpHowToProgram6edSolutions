...
// Chapter 7.
// Exercise 25 (07.31) Enhanced Guess The Number.

using System;

class EnhancedGuessTheNumber
{
    ...
    static void Main()
    {
        ...
        int attemptNumber = 0;
        // Local variable to count the number attempts.
        int attemptsCount = 0;
        ...
        while (toProceed)
        {
            ...
            Console.WriteLine($"Congratiolations. You guessed the number for {attemptsCount} attempts!");

            if (attemptsCount <= 10)
            {
                Console.WriteLine("Either your know the secret or you got lucky!");
            }
